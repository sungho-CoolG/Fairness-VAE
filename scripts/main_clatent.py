...
from solver_40dim_clatent import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--t_dim', default=20, type=int, help='dimension of the representation z')
    parser.add_argument('--c_dim', default=20, type=int, help='dimension of the representation z')
    parser.add_argument('--p_dim', default=20, type=int, help='dimension of the representation z')
